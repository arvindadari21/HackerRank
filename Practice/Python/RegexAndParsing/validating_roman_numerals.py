...
References:
    ...
    explanation with Python examples is available here. You could also go
    through the link below to read more about regular expressions in Python.
...
regex_pattern = r'{}{}{}{}$'.format(th, hu, te, on)
