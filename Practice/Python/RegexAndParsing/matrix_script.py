...
def decode(matrix):
    """
    Method decodes the matrix and extracts the data in readable format.
    :param matrix: List of strings in matrix format as shown above.
    :return: None
    """
    mat_str = ""
    for z in zip(*matrix):
