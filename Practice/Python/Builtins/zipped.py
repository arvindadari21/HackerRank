...
zip([iterable, ...])
    This function returns a list of tuples. The ith tuple contains the ith
...
Input Format:
    ...
    * The next X lines contains the space separated marks obtained by students
