...
A valid postal code  have to fulfill both below requirements:
    * P must be a number in the range from 100000 to 999999 inclusive.
    * P must not contain more than one alternating repetitive digit pair.

Alternating repetitive digits are digits which repeat immediately after the next
digit. In other words, an alternating repetitive digit pair is formed by two
equal digits that have just a single digit between them.
...
Input Format:
    ...
    and uses provided expression and your regular expressions to validate if P
...
Explanation:
    1 1 0O0O : (0, 0) and (O, O) are two alternating digit pairs. Hence, it is
