...
Your task is to detect and print all the HTML tags, attributes and attribute
values.
...
Note: Do not detect any HTML tag, attribute or attribute value inside the HTML
comment tags (<!-- Comments -->). Comments can be multiline.
...
Explanation
    ...
    * object tag: Print the object tag. In the next 4 lines, print the
                  attributes type, data, width and height along with their
                  respective values.

    * <!-- Comment --> tag: Don't detect anything inside it.

    * param tag: Print the param tag. In the next 2 lines, print the attributes
                 name along with their respective values.
"""
