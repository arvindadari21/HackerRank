...
* This section assumes that you understand the basics discussed in
  HTML Parser - Part 1
...
Output Format:
    Print the single-line comments, multi-line comments and the data in order
    of their occurrence from top to bottom in the snippet.
