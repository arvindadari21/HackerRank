...
.difference()
    The tool .difference() returns a set with all the elements from the set that
    are not in an iterable.
    Sometimes the - operator is used in place of the .difference() tool, but it
...
Output Format:
    Output the total number of students who are subscribed to the English
    newspaper only.
...
Explanation:
    The roll numbers of students who only have English newspaper subscriptions
    are:
    4, 5, 6 and 9.
