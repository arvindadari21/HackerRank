...
if i subset A, you add 1 to your happiness. If i subset B, you add -1 to your
...
Explanation:
    You gain 1 unit of happiness for elements 3 and 1 in set A. You lose 1 unit
    for 5 in set B. The element 7 in set B does not exist in the array so it is
