...
Task:
    ...
    the English newspaper, one set has subscribed to the French newspaper. Your
    task is to find the total number of students who have subscribed to both
    newspapers.
...
d = int(input())
d_list = set(map(int, input().strip().split()))

print(len(n_list.intersection(d_list)))
