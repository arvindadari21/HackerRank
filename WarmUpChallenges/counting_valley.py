...
uphill, U, or a downhill, D step. Gary's hikes start and end at sea
...
For example, if Gary's path is [D D U U U U D D], he first enters
a valley 2 units deep. Then he climbs out an up onto a mountain 2 units high.
...
if __name__ == '__main__':
    ...
    s = input("Enter the sequence of steps taken by Gary: ")

    result = counting_valleys(n, s)

    print("Number of valley Gary visited: ", result)
